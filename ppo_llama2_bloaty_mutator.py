...
def main():
    ...
    default_prompt = f"### Input: ```Based on below hex {fuzzing_target} seed, mutate a new {fuzzing_target} seed. Make sure the example is complete and valid. 0xcf0xfa,0xed0xfe,0xbb0x1,0x10x0,0x00xf8,0xff0xdf,0xb0x0,0x80x0,0x10x0,0x00x0,0x10x0,0xf70x82,0x100x3a,0x30x3,0x00x2,0xfd0xb,0x190x0,0x00x0,0x570x0,0x00x0,0x400x0,0x00x0,0xff0xff,0x00x7f,0x450x4c,0x460x1,0xbb0xe8,0xff0xff,0xff0x6,0xff0xff,0xff0x3,0x00x0,0xff0xff,0xff0xff,0xff0x0,0x800xff,0x00x0,0x00x0,0x00x0,0x00x0,0x00x0,0x00x0,0x00x0,0x00x0,0x10x0,0xdf0x34,0x00x0,0x800x0,0x00x0,0x00x0,0x00x35,0x00x0,0x00x0,0x00x0,0x350x0,0x00x0,0x350x0,0x00x0,0x00x0,0x0```"
