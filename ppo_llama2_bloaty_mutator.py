...
def main():
    ...
    default_prompt = "### Input: ```Based on below hex bloaty seed, mutate a new bloaty seed. Make sure the example is complete and valid. 0x4C0x46,0x010x01,0x010x03,0x000x00,0x000x00,0x000x00,0x000x00,0x020x00,0x030x00,0x010x00,0x7F0x45,0x4C0x46,0x010x01,0x010x03,0x050x00,0x000x00,0x000x10,0x000x00,0x010x00,0x000x00,0x930x00,0x000x00,0x740x80,0x040x08,0x340x00,0x000x00,0x000x00,0x000x00,0x000x00,0x000x00,0x340x00,0x200x00,0x020x00,0x280x00,0x000x00,0x000x00,0x010x00,0x000x00,0x740x00,0x000x00,0x740x80,0x040x08,0x740x80,0x040x08,0x1F0x00,0x000x00,0x1F0x00,0x000x00,0x050x00,0x000x00,0x000x10,0x000x00,0x010x00,0x000x00,0x930x00,0x000x00,0x930x90,0x040x08,0x930x90,0x040x08,0x0D0x00,0x000x00,0x0D0x00,0x000x00,0x060x00,0x000x00,0x000x10,0x000x00,0xB80x04,0x000x00,0x000xBB,0x010x00,0x000x00,0xB90x93,0x900x04,0x08```"
